...
export class VisitaDuenoRepository extends DefaultCrudRepository<
  ...
  constructor(
    ...
    @repository.getter('DuenoRepository') protected duenoRepositoryGetter: Getter<DuenoRepository>,
    @repository.getter('VisitaRepository') protected visitaRepositoryGetter: Getter<VisitaRepository>,
    @repository.getter('MensajeRepository') protected mensajeRepositoryGetter: Getter<MensajeRepository>,
  ) {
